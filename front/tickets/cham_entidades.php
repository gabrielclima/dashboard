...
<table style="font-size:25pt; font-weight:bold; width: 100%; margin-left: auto; margin-right: auto;"><tr><td align="center"><span class="today" ><a href="cham_entidades.php?ent=<?php echo $ent; ?>" style="color:#000099;"> <?php echo __('Today Tickets','dashboard'); ?>: </a> 
