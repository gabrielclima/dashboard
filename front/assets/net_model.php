...
WHERE `is_deleted` = 0
AND `networkequipmentmodels_id` = 0
".$ent_net." ";
...
$query_os = "
SELECT glpi_networkequipmentmodels.name AS name, count( glpi_networkequipments.id ) AS conta
...
$(function () {		
        ...
        $('#graf_net2').highcharts({
            ...
            title: {
                text: '".__('Networkequipments by Model','dashboard')."'
            },
            tooltip: {
