...
$query_os = "
SELECT glpi_manufacturers.name AS name, count( glpi_peripherals.id ) AS conta
FROM glpi_manufacturers, glpi_peripherals
WHERE glpi_peripherals.is_deleted =0
AND glpi_manufacturers.id = glpi_peripherals.manufacturers_id
...
$(function () {		
        ...
        $('#graf_perip1').highcharts({
            ...
            title: {
                text: '".__('Peripherals by Manufacturer','dashboard')."'
            },
            tooltip: {
