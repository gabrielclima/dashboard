...
<a href="../index.php"><i class="fa fa-home" style="font-size:14pt; margin-left:25px;"></i><span></span></a>
	...
	<div id="titulo_graf"> <?php echo __('Tickets', 'dashboard') .'  '. __('by Location', 'dashboard') ?> </div>
	
	<div id="datas-tec" class="span12 row-fluid" >
 
	<form id="form1" name="form1" class="form_rel" method="post" action="rel_localidade.php?con=1" onsubmit="datai();dataf();"> 
...
location.href = 'rel_localidade.php?con=1&stat=".$status1."&date1=".$data_ini2."&date2=".$data_fin2."&cat=".$id_loc ."&npage='+page;
} 
</script>
...
<tr>
<td style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> ".__('Location').": </span>".$ent_name['name']." </td>
</tr>
<tr>
...
<table align='right' style='margin-bottom:10px;'>
		<tr>
			<td colspan=3>
				<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_localidade.php?con=1&stat=open&cat=".$id_loc."&date1=".$data_ini2."&date2=".$data_fin2."&npage=".$num_por_pagina."\"' <i class='icon-white icon-trash'></i> ".__('Opened', 'dashboard') ." </button>
				<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_localidade.php?con=1&stat=close&cat=".$id_loc."&date1=".$data_ini2."&date2=".$data_fin2."&npage=".$num_por_pagina."\"' <i class='icon-white icon-trash'></i> ".__('Closed', 'dashboard')." </button>	
				<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_localidade.php?con=1&stat=all&cat=".$id_loc."&date1=".$data_ini2."&date2=".$data_fin2."&npage=".$num_por_pagina."\"' <i class='icon-white icon-trash'></i> ".__('All', 'dashboard')." </button>
			</td>	
		</tr>
</table>
