...
<table id='asset' class='display'  style='font-size: 12px; font-weight:bold;' cellpadding = 2px>
	<thead>
		<tr>
			<th style='text-align:center; font-size: 12px; font-weight:bold; color:#000; cursor:pointer;'> ".__('Name')." </th>
			<th style='text-align:center; font-size: 12px; font-weight:bold; color:#000; cursor:pointer;'> ".__('Model')."/". __('Version')." </th>
			<th style='text-align:center; font-size: 12px; font-weight:bold; color:#000; cursor:pointer;'> ".__('Serial')." </th>
			<th style='text-align:center; font-size: 12px; font-weight:bold; color:#000; cursor:pointer; text-align:center;'> ".__('Tickets','dashboard')." </th>
		</tr>
	</thead>
<tbody>";
