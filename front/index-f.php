...
$photo_url = "http://confronta.mpro.gov/fotos_rh/". $_SESSION["glpiname"] .".jpg";
                    ...
                    <div class="box-holder">
                        ...
                        <div class="left-sidebar">
                            <div class="sidebar-holder">
                                <!-- User   -->
                                <div class="user-menu">
                                    <img src="<?php echo $photo_url;?>" alt="" class="avatar" style="margin-left: -8px;">
                                    <div class="user-info">
...
<div class="row" style="margin-top: 40px;">
	...
	<div id="last_tickets" class="col-sm-6 col-md-6" style="height:300px;  margin-top:50px;"> 
